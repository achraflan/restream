...
class TagResourceIT {
    ...
    private static final String DEFAULT_TAG_NOM = "AAAAAAAAAA";
    private static final String UPDATED_TAG_NOM = "BBBBBBBBBB";
    ...
    public static Tag createEntity(EntityManager em) {
        Tag tag = new Tag().tagNom(DEFAULT_TAG_NOM);
        return tag;
    }
    ...
    public static Tag createUpdatedEntity(EntityManager em) {
        Tag tag = new Tag().tagNom(UPDATED_TAG_NOM);
        return tag;
    }
    ...
    void createTag() throws Exception {
        ...
        assertThat(testTag.getTagNom()).isEqualTo(DEFAULT_TAG_NOM);
    }
    ...
    void putNewTag() throws Exception {
        ...
        updatedTag.tagNom(UPDATED_TAG_NOM);
        ...
        Tag testTag = tagList.get(tagList.size() - 1);
        assertThat(testTag.getTagNom()).isEqualTo(UPDATED_TAG_NOM);
    }
    ...
    void partialUpdateTagWithPatch() throws Exception {
        ...
        partialUpdatedTag.tagNom(UPDATED_TAG_NOM);
