            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('dateCreation')}>
                  Date Creation <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  Chemin <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {reportList.map((report, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {report.dateCreation ? <TextFormat type="date" value={report.dateCreation} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>{report.chemin ? <Link to={`chemin/${report.chemin.id}`}>{report.chemin.id}</Link> : ''}</td>
